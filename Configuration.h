...
#define STRING_VERSION_CONFIG_H __DATE__ "16/09/2015 1833h" __TIME__ // build date and time
#define STRING_CONFIG_H_AUTHOR "(Rafi Khan, zetoslab@gmail.com)" // Who made the changes.
